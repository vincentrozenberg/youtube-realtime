var baseURL = "http://vincentrozenberg.github.io/youtube-realtime/";
if(window.top !== window.self) window.top.location.replace(window.self.location.href);
if(location.hostname.indexOf("http://vincentrozenberg.github.io/") == -1 && location.hostname != "localhost") location.replace(baseURL + location.hash);
